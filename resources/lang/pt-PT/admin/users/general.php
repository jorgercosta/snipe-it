...
return [
    ...
    'bulk_update_help'    => 'Este formulário permite que atualize vários utilizadores de uma só vez. Apenas preencha os campos que você precisa alterar. Todos os campos deixados em branco permanecerão inalterados.',
    ...
    'send_email_help'   => 'Deve fornecer um endereço de e-mail para este utilizador para enviar-lhe credenciais. Credenciais via e-mail só podem ser feitas na criação do usuário. As palavras-passe são armazenadas em hash e não podem ser recuperadas depois de salvas.',
